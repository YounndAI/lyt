...
name: lyt-capture
description: >
  Capture a durable Markdown Figment when the user runs /lyt-capture or asks to save content in Lyt. Uses the required frontmatter contract; retrieval uses /lyt-recall or /lyt-search.
visibility: public
skill-version: 1.0.0
