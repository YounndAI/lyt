...
name: lyt-recall
description: >
  Search one Lyt vault when the user runs /lyt-recall or asks what they wrote in a specific vault. It returns ranked Figments; use /lyt-search for pod- or mesh-wide queries.
visibility: public
skill-version: 1.0.0
