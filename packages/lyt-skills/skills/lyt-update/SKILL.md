...
name: lyt-update
description: >
  Check or update installed Lyt when the user runs /lyt-update or asks about Lyt currency. It uses the configured channel; updating needs confirmation and never substitutes raw npm.
visibility: public
skill-version: 1.0.0
