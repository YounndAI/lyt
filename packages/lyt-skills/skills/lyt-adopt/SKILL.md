...
name: lyt-adopt
description: >
  Adopt an existing Markdown directory into Lyt when the user runs /lyt-adopt or asks to bring a folder into Lyt. Additive-only; it never edits existing Markdown. New vaults use /lyt-create.
visibility: public
skill-version: 1.0.0
