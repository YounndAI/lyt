...
- `.obsidian/` — optional Obsidian config, created only with `lyt vault init --template obsidian-default`
- `notes/` — Figments (markdown notes) live here
- `.lyt/patterns/` — symlinks to installed Lyt patterns (machine-local; gitignored)
