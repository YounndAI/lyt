...
async function emitVaultStubCanvas(
  ...
  nodes.push(
    textNode(
      ...
      [
        "> [!warning] Federation-repo not yet shipped — vault-local snapshot",
        ">",
        ...
        ">",
        "> Run `lyt federation init` to forge a federation repo; full federation-aggregation canvas support is coming in a future release.",
      ].join("\n"),
      NODE_COLOR_WARNING,
    ),
  );
